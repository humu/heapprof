...
1. Go to `https://circleci.com/gh/humu/heapprof/tree/master` and click on the link for the
   most recent `windows_64` job. For each of them, click on the "Artifacts" tab
   and download the corresponding wheel. Move it to your `dist` directory along with the wheels
